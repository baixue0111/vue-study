 <template>
  <div>
    ...
    <div class="con-top" >
     ...
     <span v-title data-title="新品上架-好书幸运购 好书推荐给更多读者 让更多读者了解好书 "></span>    
   <div class="hrdm_con">
     <div class="hrdm_nav">
...
// import {luckybuyNewArrivalsMore} from '../../../service/getData'
...
export default {
  ...
  methods:{
      fetchData(page,limit,filterkey){
          luckybuyNewArrivalsMore(page,limit,filterkey).then(res => {
            this.items = res
          })      
      },
