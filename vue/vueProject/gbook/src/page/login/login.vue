    ...
    <div>
        ...
        <form class="loginForm" v-else>
            ...
            <section class="input_container captcha_code_container">
                <input type="text" id="vcode" placeholder="验证码" maxlength="4" v-model="codeNumber">
...
<script>
    ...
    import {checkExsis,vCode} from '../../service/getData'
    ...
    export default {
        ...
        methods: {
            ...
            async getCaptchaCode(){
                    let res = await vCode();
                    this.captchaCodeImg = res.imgUrl;
                    // console.log('res='+res.imgUrl)
            },
            //获取短信验证码
            async getVerifyCode(){
