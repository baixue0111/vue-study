...
const config = require('../config')  // 获取confing/index.js 默认配置
...
const webpackConfig = require('./webpack.dev.conf')   // 使用dev环境的webpack配置
...
app.use(hotMiddleware)  // 把Hot-reload挂载到express服务上
